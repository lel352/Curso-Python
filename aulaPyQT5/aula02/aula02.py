...
class Calculadora(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle('Calculadora do Leandro')
        self.setFixedSize(400, 400)  # tamanho fixo
        self.cw = QWidget()
        self.grid = QGridLayout(self.cw)

        self.display = QLineEdit()
        self.grid.addWidget(self.display, 0, 0, 1, 5)  # linha , coluna, ocupando uma linha, ocupando 5 colunas
        self.display.setDisabled(True)  # pessoa não pode digitar
        self.display.setStyleSheet(  # igual css
