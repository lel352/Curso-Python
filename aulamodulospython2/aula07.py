...
print('mes ', calendar.month(2024, 12))
print('dia da semana e  ultimo dia e que ', calendar.monthrange(2022, 12))
numero_primeiro_dia, ultimo_dia = calendar.monthrange(2022, 12)
print('Dias da semana', list(enumerate(calendar.day_name)))
